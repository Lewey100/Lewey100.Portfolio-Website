...
<img class="imgcol" src="images/BBE.jpg">
<h2> Big-Time BubbleGum Encounter</h2>
<p> I am currently working within a small team of talented game development students to create a totally new indie game, Big-Time Bubblegum Encounter! Our indie studio is named Indigo Dogs and the development process is coming along very well. An alpha version of the game shall be made available within the coming weeks. BBE is a First Person Shooter built within the Unreal Engine 4 and incorporates tower defence elements into the gameplay, similar to Sanctum.
</p>
</div>
<div class="Portfolio-Items">
<a href="Downloads/OOP_Project.exe"> <img class="imgcol" src="images/CatMouse.jpg"></a>
<h2> Cat and Mouse Object Oriented C++ Game </h2>
<p> During my second year we were tasked to create a Cat vs Mouse chase game using C++ in a Windows application. We were required to use the elements of Object Oriented Programming that makes it so powerful such as Inheritance, Encapsulation and Abstraction. We also had to think of our own gameplay tweaks the make the application slightly more interesting and implement these into the game. You can download the .exe by clicking the photo above!</p>

</div>
<div class="Portfolio-Items">
<img class="imgcol" src="images/DirectXGame.jpg">
<h2> DirectX 11 Work </h2>
<p> During my second year we have started to work on creating games using the DirectX 11 toolkit, we have been adding some features to this Astro Blaster game which will prepare us to create our own game for an assignment further in the year.
</p>
</div>
<div class="Portfolio-Items">
<a href="JumpGame/Jump.html"> <img class="imgcol" src="images/JUMP.jpg"> </a>
<h2> Jump! Platformer Unity Game </h2>
<p> For a first year assignment I was tasked to create a platformer using Unity in a team of 3. We added various behaviours to each platform and items the player can pick up for some help (or hinderance!). Click the image to test the game! (Requires Unity Web Player | Chrome not supported)</p>
</div>
<div class="Portfolio-Items">
<img class="imgcol" src="images/SnailTrail.jpg">
<h2> Snail Trail Optimisation Assignment </h2>
<p>In my module Software Hardware Optimisation Techniques I was given an assignment where I was required to optimise a C++ game to achieve the best possible performance. I used a number of techniques when trying to achieve this such as: Inlining functions to save the function call overhead, reordering branches to make sure the most probable option was the first to be checked, unravelling loops to save the loop overhead and rewritting how the game was drawn onto the grid. I also employed OpenMP to make use of multithreading so the loops could be calculated quicker.
</p>
</div>
<div class="Portfolio-Items">
<a href="Downloads/Zombie_Game.exe"><img class="imgcol" src="images/ZombieGame2.jpg"></a>
<h2> Zombie Game C++ Assignment </h2>
<p>
During first year we were seperated into groups to work on a simple C++ zombie game. We were given the base grid and player movement and had to implement the other features such as: Zombie AI, Power Pills, Level Design, Leaderboards and a save/load function. You can download the .exe by clicking the photo!
</p>
</div>
...
$query= "SELECT * FROM PersonalPortfolioCMS";
 $result = mysqli_query($mysqli, $query);
      ...
      for($i=0; $i<$num_results; $i++) {
       ...
       echo "<div class=\"Portfolio-Personal\">" .
        $Link1 . "<img class=\"imgcol\" src=\"" . $row['photo'] . "\">" . $Link2  . "<h2>" . $row['Title'] .
          "</h2>" . "<p>" . $row['Description'] . "</p>" . "</div>";
      }
